<script lang="ts">
	...
	onMount(fetchDates); // Llama a fetchDates cuando el componente se monte
		...
		<div class="max-w-3xl px-2.5 -mb-0.5 mx-auto inset-x-0">
			...
			<div class="bg-gradient-to-t from-white dark:from-gray-800 from-40% pb-2">
				...
				<div class="mt-1.5 text-xs text-gray-500 text-center">
					Los LLMs pueden cometer fallos al analizar los documentos del BOE. Verifica la información
					importante.
				</div>
			</div>
		</div>
